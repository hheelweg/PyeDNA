...
# Job Submission
srun pmemd.cuda -O -i dna_test_eq1.in -o dna_test_eq1.out -p dna_test.prmtop -c ../min/dna_test_min2.ncrst -r dna_test_eq1.ncrst -ref ../min/dna_test_min2.ncrst
srun pmemd.cuda -O -i dna_test_eq2.in -o dna_test_eq2.out -p dna_test.prmtop -c dna_test_eq1.ncrst -r dna_test_eq2.ncrst -ref dna_test_eq1.ncrst
wait
